...
HD_PWD='C:/HWSynLab/Lab_4/Lab_4.runs/design_1_adder_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_adder_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_adder_0.tcl
