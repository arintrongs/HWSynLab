...
HD_PWD='D:/CP/CP 3-2/HWLab/lab05/lab05.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system3.tcl
