...
HD_PWD='D:/CP/CP 3-2/HWLab/lab05/lab05.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log system3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source system3.tcl -notrace
