...
adder	#(.WIDTH(16)) PCADDER(pc_add,pc_cout,pc[15:0],pc_add_b,1'b1);
mux2_1	#(.WIDTH(16)) MUXADDPC(pc_add_b,{16{1'b0}},imm,sel_addpc);
mux2_1	#(.WIDTH(16)) MUXSELPC(pc_new,pc_add,addr,sel_pc);
