...
proc create_root_design { parentCell } {
  ...
  set SUBOUT [ create_bd_port -dir O -from 4 -to 0 -type data SUBOUT ]
  ...
  connect_bd_net -net CLK_0_1 [get_bd_ports CLK_0] [get_bd_pins adder/CLK] [get_bd_pins multiplier/CLK] [get_bd_pins subtractor/CLK]
